...
class ResourceFactory {
    ...
    private fun createFireResource3(): Resource {
        val vehicleList = mutableListOf<VehicleType>(
            VehicleType.FIRE_TRUCK_WATER, VehicleType.FIRE_TRUCK_WATER,
            VehicleType.FIRE_TRUCK_WATER, VehicleType.FIRE_TRUCK_WATER, VehicleType.FIRE_TRUCK_WATER, VehicleType.FIRE_TRUCK_WATER,
            VehicleType.FIRE_TRUCK_LADDER, VehicleType.FIRE_TRUCK_LADDER, VehicleType.FIREFIGHTER_TRANSPORTER,
        ...
        val waterConstant = 5400
        val patientConstant = 2
        val ladderConstant = 40
        return Resource(vehicleList, waterConstant, 0, patientConstant, ladderConstant)
    }
    ...
    fun createAccidentResources(severity: Int): Resource {
        if (severity == 1) {
            ...
            val vehicleList =
                mutableListOf<VehicleType>(
                    VehicleType.FIRE_TRUCK_TECHNICAL, VehicleType.FIRE_TRUCK_TECHNICAL, VehicleType.FIRE_TRUCK_TECHNICAL, VehicleType.FIRE_TRUCK_TECHNICAL,
