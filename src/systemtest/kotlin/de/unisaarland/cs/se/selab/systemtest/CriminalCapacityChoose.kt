...
class CriminalCapacityChoose : SystemTest() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("Asset Allocation: 12 allocated to 0; 1 ticks to arrive.")
        ...
        assertNextLine("Asset Arrival: 10 arrived at 4.")
        assertNextLine("Asset Arrival: 11 arrived at 4.")
        assertNextLine("Asset Arrival: 12 arrived at 2.")
