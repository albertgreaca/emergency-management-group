...
class DoubleRealloc : SystemTest() {
    ...
    override suspend fun run() {
        ...
        assertNextLine("Asset Request: 3 sent to 3 for 0.") // request for sev 0 em (ambulancia was reallocated)
        assertNextLine("Asset Allocation: 1 allocated to 2; 2 ticks to arrive.")
        assertNextLine("Asset Allocation: 2 allocated to 2; 2 ticks to arrive.")
        assertNextLine("Request Failed: 2 failed.")
        assertNextLine("Asset Allocation: 7 allocated to 2; 4 ticks to arrive.") // now the 3 ambulancias for sev 2
        ...
        assertNextLine("Asset Allocation: 10 allocated to 0; 4 ticks to arrive.") // ambulance for sev 0
        ...
        assertNextLine("Asset Arrival: 10 arrived at 3.") // sev 0 and 2 handling will now start, sev 1 next tick
        assertNextLine("Emergency Handling Start: 0 handling started.")
        assertNextLine("Emergency Handling Start: 2 handling started.")
        assertNextLine("Simulation Tick: 8")
        assertNextLine("Asset Arrival: 11 arrived at 5.")
        assertNextLine("Asset Arrival: 12 arrived at 5.")
