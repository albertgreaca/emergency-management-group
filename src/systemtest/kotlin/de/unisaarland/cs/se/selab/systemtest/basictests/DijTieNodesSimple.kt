...
class DijTieNodesSimple : SystemTest() {
    override val name = "DijTieNodesSimple"

    override val map = "mapFiles/dijkstraTieNodes.dot"
    ...
    override suspend fun run() {
        assertNextLine("Initialization Info: dijkstraTieNodes.dot successfully parsed and validated")
        assertNextLine("Initialization Info: dijTieAss.json successfully parsed and validated")
        assertNextLine("Initialization Info: dijTieNodesScen.json successfully parsed and validated")
